...
struct task_info task2_14 = {(ptr_t)&priority_task1, USER_PROCESS, 104};
struct task_info task2_15 = {(ptr_t)&priority_task2, USER_PROCESS, 90};
struct task_info task2_16 = {(ptr_t)&priority_task3, USER_PROCESS, 82};
struct task_info task2_17 = {(ptr_t)&priority_task4, USER_PROCESS, 73};
struct task_info task2_18 = {(ptr_t)&priority_task5, USER_PROCESS, 69};
struct task_info task2_19 = {(ptr_t)&priority_task6, USER_PROCESS, 56};
struct task_info task2_20 = {(ptr_t)&priority_task7, USER_PROCESS, 41};
struct task_info task2_21 = {(ptr_t)&priority_task8, USER_PROCESS, 34};
struct task_info task2_22 = {(ptr_t)&priority_task9, USER_PROCESS, 23};
struct task_info task2_23 = {(ptr_t)&priority_task10, USER_PROCESS, 10};
struct task_info *priority_tasks[16] = {&task2_14, &task2_15, &task2_16, &task2_17, &task2_18, 
                                        &task2_19, &task2_20, &task2_21, &task2_22, &task2_23};
